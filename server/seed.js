...
const AREAS = [
  {
    name: "Board Room", icon: "🏛️", color: "#1565C0", order: 1, subs: [
      { name: "Company Profile", pic: "DMD san", min: 10, order: 1 },
      { name: "HOD Introduction", pic: "DMD san", min: 5, order: 2 },
      { name: "India Business Outlook", pic: "Amit san", min: 15, order: 3 },
      { name: "Manufacturing Competitiveness & Kadai", pic: "DMD san", min: 15, order: 4 },
      { name: "TNGA Future Volume", pic: "Lokesh san", min: 5, order: 5 },
      { name: "Cap up Plan (900D & Kamigo B/Localization)", pic: "Lokesh san", min: 7, order: 6 },
  ...
  },
  {
    name: "GD Area", icon: "🔧", color: "#2E7D32", order: 2, subs: [
      { name: "Walk Through Explanation at Machining (Head > Crank > Block)", pic: "Antonoy san", min: 15, order: 1 },
      { name: "Walk Through Explanation at Assemble Mendomi", pic: "Antonoy san", min: 10, order: 2 },
      { name: "CR (Localization Kaizens)", pic: "Pavan san", min: 10, order: 3 },
      { name: "Environment Kaizen", pic: "Naveen san", min: 10, order: 4 },
      { name: "Inhouse Cost Mgt / Control System", pic: "Sathisha san", min: 15, order: 5 },
      { name: "GL/TL Mendomi (GD Assy/GD Mach)", pic: "Anotony san", min: 10, order: 6 },
    ]
  },
  {
    name: "TNGA Assembly", icon: "🏭", color: "#E65100", order: 3, subs: [
      { name: "Line Layout & ΣcT Reduction Activity", pic: "Vijayanad san", min: 15, order: 1 },
  ...
  },
  {
    name: "TNGA Machining", icon: "⚙️", color: "#AD1457", order: 4, subs: [
      ...
      { name: "Machine Reliable Enhancement", pic: "Prashanth san", min: 10, order: 2 },
  ...
  },
  {
    name: "DOJO", icon: "🥋", color: "#6A1B9A", order: 5, subs: [
      { name: "Dojo - Overview", pic: "Manu /Brijendra san", min: 20, order: 1 },
  ...
  },
  {
    name: "Supplier", icon: "📦", color: "#4527A0", order: 7, subs: [
      { name: "TNGA 5C Parts Status (Supplier Parts) — Block, Head, Cam", pic: "Manu /Brijendra san", min: 10, order: 1 },
    ]
  },
];

const TRANSIT = [
  { label: "Move by Buggy", pic: "Nethra san", min: 3 },
  { label: "Move by Walk", pic: "Nethra san", min: 2 },
  { label: "Move by Bus", pic: "Nethra san", min: 5 },
